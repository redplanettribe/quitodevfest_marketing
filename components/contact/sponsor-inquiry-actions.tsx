...
import { Copy, ExternalLink, FileInput, Mail } from "lucide-react"
...
export function SponsorInquiryActions() {
  ...
  return (
    <div className="mx-auto flex max-w-xl flex-col items-center gap-6">
      ...
      >
        Completar formulario de patrocinio
      </CTAButton>
      ...
      <p className="text-center text-sm text-muted-foreground">{sponsorInquiry.responseTime}</p>
    </div>
  )
}
